...
public:
    ...
    virtual void drawObj(const Renderer *renderer, int gridLeft, int gridRight,
                         int gridTop, int gridBottom) const = 0;
    virtual void drawObjSelected(const Renderer *renderer, int gridLeft, int gridRight,
                                 int gridTop, int gridBottom) const = 0;
