...
public:
     ...
     *
     * This constructor creates a new Shader object and initializes it with an
     ...
     *
     * This method binds the Shader to the current OpenGL context. This allows
     * the Shader to be used in subsequent OpenGL calls.
     */
    void bind() const;
     ...
     *
     * This method adds a shader of the specified type to the Shader. The shader
     * is loaded from the file at the specified path.
     *
     ...
     *
     * This method compiles the Shader program by attaching the shaders to the
     * program and linking the program.
     */
    void compileShader();
