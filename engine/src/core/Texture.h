...
public:
     ...
     *
     * This constructor creates a new Texture object and initializes it with the
     * texture data loaded from the image file at the specified path.
     *
     ...
     *
     * This method binds the Texture to the current OpenGL context. This allows
     * the Texture to be used in subsequent OpenGL calls.
     *
