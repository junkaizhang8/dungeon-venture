...
namespace Engine
{
    ...
    public:
         ...
         *
         * This destructor destroys the VertexBuffer object and frees any
         ...
         *
         * This method binds the VertexBuffer to the current OpenGL context.
         * This allows the VertexBuffer to be used in subsequent OpenGL calls.
         */
        void bind() const;
