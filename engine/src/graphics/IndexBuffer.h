...
namespace Engine
{
     ...
     *
     * This class provides a simple interface for creating and managing index
    ...
    public:
         ...
         *
         * This constructor creates a new IndexBuffer object and initializes it
         ...
         *
         * This destructor destroys the IndexBuffer object and frees any
         ...
         *
         * This method unbinds the IndexBuffer from the current OpenGL context.
         * This prevents the IndexBuffer from being used in subsequent OpenGL
         * calls.
         */
        void unbind() const;
